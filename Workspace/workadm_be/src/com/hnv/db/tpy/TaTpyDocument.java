...
public class TaTpyDocument extends EntityAbstract<TaTpyDocument> {
	...
	public final static int 		TYPE_01_FILE_OTHER				= 2; //--all
	...
	public static final String	COL_T_INFO_01                         =	"T_Info_01"; //--name
...
//				doc.reqSet(TaTpyDocument.ATT_T_INFO_02 , null); //hide to client the path real in server
	...
	public static List<TaTpyDocument> reqTpyDocuments (Integer parentType, Set<Integer> parentId, Integer type01, Integer type02) throws Exception{		
		Criterion cri = Restrictions.gt("I_ID", 0);	
		...
		return TaTpyDocument.DAO.reqList_In(TaTpyDocument.ATT_I_ENTITY_ID, parentId, cri);
	}
	...
	public static void doBuildTpyDocuments(List listEnts, Integer parentType, Integer type01, Integer type02, String attrDocsName, boolean forced) throws Exception{
		...
		List<TaTpyDocument> docs = reqTpyDocuments(parentType, tabDocs.keySet(), type01, type02);
	...
	// 
	public static List<TaTpyDocument> reqListCheck (int mode, TaAutUser user, Integer entTyp, Integer entID,  JSONArray lstJson) throws Exception {
...
//				}
	...
	private static List<TaTpyDocument> reqListSaveFromNewToValidated(TaAutUser user, Integer entTyp, Integer entID, List<TaTpyDocument> docs) throws Exception {
