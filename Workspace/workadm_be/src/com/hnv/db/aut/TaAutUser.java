...
public class TaAutUser extends EntityAbstract<TaAutUser> {
	...
	public static final int 	TYPE_01_MENTOR     	= 5;
	public static final int 	TYPE_01_CLIENT		= 6;
...
//	public static final String ATT_O_SUPERIOR	    = "O_Superior";
	...
	public static void doBuildAvatar(List<TaAutUser> usersLst) throws Exception {
		...
		if(!ids.isEmpty()) {
			...
			List<TaTpyDocument> avas = TaTpyDocument.DAO.reqList_In(TaTpyDocument.ATT_I_ENTITY_ID, ids, 
					Restrictions.and(
							Restrictions.eq(TaTpyDocument.ATT_I_ENTITY_TYPE, DefDBExt.ID_TA_AUT_USER),
							Restrictions.eq(TaTpyDocument.ATT_I_TYPE_01, TaTpyDocument.TYPE_01_FILE_MEDIA),
							Restrictions.eq(TaTpyDocument.ATT_I_TYPE_02, TaTpyDocument.TYPE_02_FILE_IMG_AVATAR)));
